 ...
 * @author Kanoksilp
 */
public class MoreComplexListCellRenderer
	...
	public MoreComplexListCellRenderer() {
	...
	public Component getListCellRendererComponent(JList list, Object value,
		...
		MoreComplexListItem item = (MoreComplexListItem) value;
		...
		if (isSelected) {
			...
			this.adjustColors(item.getBackgroundTint(), Color.BLACK,
					this, textPanel, titleLabel, infoLabel);
